...
<p>To set the 'directionality' of the whole document e.g. to reverse default alignment, tables, lists etc. you can either specify a language configured to use 'rtl' e.g.</p>
<p>\$mpdf = new mPDF('ar');</p>
...
// You can get the same effect as using 'ar' by setting:
